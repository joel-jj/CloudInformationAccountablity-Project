...
<%
String si=(String)session.getAttribute("fnm");
String sql="select * from upload  where filename='"+si+"'";
String id1=null,filename1=null,ownername1=null,utime=null,cost=null,recost=null,fkey2=null;
try
{
...
session.setAttribute("dcostx",cost);
session.setAttribute("recostx",recost);
...
<form name="f1" action="update_redown_key.jsp" method="post" onSubmit="return valid4()">
<div id="container" class="clearfix">
 ...
 <div id="content">
	  ...
	  <td class="c1">:</td>
	  <td><input type="text" class="c2" Value=<%=id1%> name="id"  disabled /></td>
	  </tr>
	  ...
	  <tr>
	  <td class="c1">DOWNLOAD COST</td>
	  <td class="c1">:</td>
	  <td><input type="text" class="c2" name="dcost"value=$<%=cost%> disabled></td>
	  </tr>
	  
	  <tr>
	  <td class="c1">REDOWNLOAD COST</td>
	  <td class="c1">:</td>
	  <td><input type="text" class="c2" name="rcost"value=$<%=recost%> disabled></td>
	  </tr>
	  ...
	  <td><input type="reset" value="RESET"></td>
        ...
        <ul id="nav">
            ...
            <li><a href="redownload1.jsp">Back</a></li>    
