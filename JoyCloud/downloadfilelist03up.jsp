...
<body>
<form name="frm" action="fileupdload.jsp" method="post" onSubmit="return valid2()">
<div id="container" class="clearfix">
 ...
 <div id="content">
		...
		<tr><td></td><td></td><td><input type="submit" style="color:black;background:#cccccc" value="VIEW FILELIST" name="submit"></td></tr>
