...
<body>
<form name="form1" action="insert.jsp" method="post" onSubmit="return valid1()">
 ...
 <div id="content">
      ...
      <h3> REGISTRATION</h3>
       ...
       <td><input name="dob" type="Text" id="demo1" maxlength="25" size="20"><a href="javascript:NewCal('demo1','ddmmmyyyy',true,24)"><img src="cal.gif" width="16" height="16" border="0" alt="Pick a date"></a>
        ...
        <td><font color="#FFFFFF">:</font></td>
        <td><select name="utype"><option value="0">--Select--</option><option value="owner">Owner</option><option value="csp">CSP</option><option value="user">User</option></select></td></tr>
      ...
      <div class="regimage"> <img src="images/registration form logo.jpg"  width="140" height="238"> 
      </div>
