...
String z=(String)session.getAttribute("gk");
String cpnm3=(String)session.getAttribute("cspnm1");
...
String mail=(String)session.getAttribute("mid");
...
PreparedStatement ps=conn.prepareStatement ("insert into redownload (fileid,filename,ownername,uploadtime,downloadcost,redownloadcost,modeofthepayment,nameofthecard,accno,expirydate,cspname,username,downloadtime,filekey,mailid) values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
...
int x=ps.executeUpdate();
            ...
            if(x==0)
				...
				response.sendRedirect("send_key_redown.jsp");
